...
@section('admin_title','Create Sub Category - Admin Panel')
        ...
        <div class="col-xl-8 col-lg-10 col-md-12">
            <div class="admin-form-card admin-form-shadow">
                <div class="admin-form-card-header">
                    <h4 class="mb-0 text-white">Add New Sub Category</h4>
                </div>
                <div class="card-body">
                    @if (session('message'))
                    ...
                    <form action="{{ route('subcategory.store') }}" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror"   id="name" name="name" value="{{ old('name') }}" placeholder="Enter sub category name">
                            @error('name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
